...
import cn.yubajin.demo.springcloudnacosconfig.config.OrderProperties;
...
public class DemoController {
    ...
    @Autowired
    private cn.yubajin.demo.springcloudnacosconfig.config.OrderProperties orderProperties;
